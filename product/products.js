...
document.querySelector('.all-products').innerHTML = 
    ...
    createProduct('rolo-guiador', 'Rolo Guiador', 'Rolo guiador Utilizado para portões industriais PCF.') + 
    createProduct('base-do-rolo', 'Base do rolo guiador', 'Base do rolo guiador, Utilizado com rolo guiador.') +
    createProduct('bucha-rosca', 'Bucha c/ rosca', 'Bucha de 45mm/40mm/30mm com rosca.');